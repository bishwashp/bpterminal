...
<script lang="ts">
	...
	import { onMount, SvelteComponent } from 'svelte'; // Import SvelteComponent for typing
	...
	// Use proper type for Svelte component
	let PostContentComponent: typeof SvelteComponent | null = null; // Start as null
	...
	onMount(async () => {
		try {
			...
			if (modules[modulePath]) {
				// Use correct type in assertion
				const module = await modules[modulePath](); // module is already typed by glob
